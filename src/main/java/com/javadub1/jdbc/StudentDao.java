...
public class StudentDao {
    ...
    private final static String CREATE_TABLE_STATEMENT =
            "create table IF not exists students(\n" +
                    ...
                    ");";
    private final static String INSERT_STUDENT_STATEMANT =
    ...
    public void insertStudent(Student student) {
        try (PreparedStatement statement = jdbcConnection.getConnection().prepareStatement(INSERT_STUDENT_STATEMANT)) {
